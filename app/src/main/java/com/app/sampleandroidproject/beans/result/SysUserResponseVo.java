...
public class SysUserResponseVo {
    ...
    @Generated(hash = 2039292241)
    public SysUserResponseVo(Long id, int bindingStatus, String deptId, String deptName, String email,
                             String homeTown, int isGesturePassword, int isSound, int isStopSpeak, int isVibration,
                             String mobile, String personalSign, String postId, String postLevelName, String postName,
